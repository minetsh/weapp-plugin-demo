...
var List = (_temp2 = _class = function (_BaseComponent) {
  ...
  function List() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = List.__proto__ || Object.getPrototypeOf(List)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray0", "list"], _this.customComponents = ["ListItem"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(List, [{
    ...
    value: function _createData() {
      ...
      var loopArray0 = this.__state.list.map(function (item, _anonIdx) {
        ...
        var $compid__0 = (0, _index.genCompid)(__prefix + "ZZLtmVrvog" + _anonIdx);
